...
export function createKakomiApp(notify = () => {}) {
  const app = {
    $refs: {},
    $nextTick(callback) {
    ...
    set model(value) {
      this.models = { ...this.models, [this.agent]: value };
    },
    ...
    async clearChat() {
      ...
      this.messagesByVersion = { ...this.messagesByVersion, [this.selected]: [] };
    ...
    async deleteVersion(version) {
      ...
      try {
        ...
        const messagesByVersion = { ...this.messagesByVersion };
        delete messagesByVersion[version.path];
        this.messagesByVersion = messagesByVersion;
        await this.refresh();
    ...
    async improve() {
      ...
      const messages = [
        ...(this.messagesByVersion[versionDir] || []),
        { role: "user", text: idea },
      ];
      this.messagesByVersion = { ...this.messagesByVersion, [versionDir]: messages };
    ...
    async pollLogs() {
      try {
        ...
        this.codingLogs = codingAgentState.versionDir === this.selected
...
globalThis.kakomiApp = createKakomiApp;
